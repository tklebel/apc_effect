...
```{r papers-p-continent, fig.width=9, fig.height=3}
...
```{r concept-overview, fig.height=6, fig.width=8}
...
```{r apc-composite, fig.height=8.5, fig.width=8}
p1 / p2 +
...
Using ggrepel
```{r field-selection, fig.width=8, fig.height=5}
...
```{r composite-field, fig.height=10, fig.width=8}
(final_ptop_apc_field + 
